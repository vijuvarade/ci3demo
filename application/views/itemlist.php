                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        <li class="active">
                          ...
                          <li class="treeview">
                            <a href="#">
                                <i class="fa fa-th-list"></i> <span>Items</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="view/additem.html"><i class="fa fa-angle-double-right"></i> Add New Item</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="view/additem.html"><i class="fa fa-angle-double-right"></i> Add New Cateory</a></li>
                            </ul>
                        </li>
